...
public class ReadEventPostDetailResponse {
    ...
    public static ReadEventPostDetailResponse of (Post post, EventPost eventPost, List<ReadParticipantListResponse> participants, List<String> attachmentUrls, List<ReadCommentsResponse> comments) {
